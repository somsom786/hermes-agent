...
const STATE_ALIASES: Record<PetState, string[]> = {
  idle: ['idle'],
  walk_left: ['walk_left', 'walking-left', 'running-left', 'run', 'running'],
  walk_right: ['walk_right', 'walking-right', 'running-right', 'run', 'running'],
  sit: ['sit', 'sitting', 'idle'],
  sleep: ['sleep', 'sleeping', 'waiting', 'idle'],
  dragged: ['dragged', 'jump', 'jumping', 'run', 'running'],
  prefall: ['prefall', 'jump', 'jumping'],
  fall_left: ['fall_left', 'falling-left', 'running-left', 'jump', 'jumping'],
  fall_right: ['fall_right', 'falling-right', 'running-right', 'jump', 'jumping'],
  land: ['land', 'landing', 'jump', 'jumping', 'idle'],
  recover: ['recover', 'recovering', 'idle'],
  listening: ['listening', 'waiting'],
  thinking: ['thinking', 'review', 'running'],
  talking: ['talking', 'waving', 'waiting'],
  writing: ['writing', 'review'],
  concerned: ['concerned', 'failed'],
...
const ROW_TO_STATE: Record<string, PetState> = {
  ...
  prefall: 'prefall',
  fall_left: 'fall_left',
  'falling-left': 'fall_left',
  fall_right: 'fall_right',
  'falling-right': 'fall_right',
  land: 'land',
  landing: 'land',
  recover: 'recover',
  recovering: 'recover',
